                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            {!! Form::model($task,['method'=>'PATCH','action'=>['Employee\TaskController@update',$task->id],'class'=>'form-horizontal form-bordered','enctype' => 'multipart/form-data','id'=>'formID']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    {!! Form::select('level',['high'=>'High','low'=>'Low','medium'=>'Medium'],null,['class'=>'form-control selectpicker','placeholder'=>"Chose"])!!}
